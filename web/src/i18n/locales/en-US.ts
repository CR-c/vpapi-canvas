export default {
    ...
    config: {
        ...
        quickSetup: {
            title: "Connect vpapi in one step",
            description: "Paste your API key and the canvas imports every model with its image, video, or text capability.",
            keyPlaceholder: "Paste your API key (sk-…)",
            connect: "Connect and load models",
            connected: "Connected and imported {{count}} models",
            failed: "Connection failed. Check the API key and base URL.",
            missingKey: "Enter your API key first",
            empty: "This key has no available models. Ask your provider to enable model access.",
        },
        channelEditor: {
            title: "Edit provider",
            name: "Provider name",
            protocol: "Protocol",
            formats: { vpapi: "vpapi (recommended)" },
