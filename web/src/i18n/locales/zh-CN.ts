export default {
    ...
    config: {
        ...
        quickSetup: {
            title: "一步接入 vpapi",
            description: "填入 API Key 即可自动拉取模型并识别生图 / 视频 / 文本能力。",
            keyPlaceholder: "粘贴 API Key（sk-…）",
            connect: "接入并拉取模型",
            connected: "接入完成，已导入 {{count}} 个模型",
            failed: "接入失败，请检查 API Key 与接口地址",
            missingKey: "请先填写 API Key",
            empty: "该 Key 下没有可用模型，请联系服务方开通模型权限",
        },
        channelEditor: {
            title: "编辑渠道",
            name: "渠道名称",
            protocol: "协议",
            formats: { vpapi: "vpapi（推荐）" },
            baseUrl: "接口地址",
            models: "渠道模型",
