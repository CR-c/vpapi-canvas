...
import { ChannelQuickSetup } from "@/components/layout/channel-quick-setup";
...
export function AppConfigPanel({ showDoneButton = false, initialTab = "channels" }: { showDoneButton?: boolean; initialTab?: ConfigTabKey }) {
    ...
    const updateChannels = (channels: ModelChannel[]) => saveConfig(applyChannels(config, channels));
...
function apiFormatLabel(apiFormat: ApiCallFormat) {
    ...
    if (apiFormat === "vpapi") return "vpapi";
    return "OpenAI";
}
